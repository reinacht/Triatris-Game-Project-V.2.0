...
# MAIN OCTAGON OBJECT (SEGI DELAPAN)
class Octagon:
    def __init__(self, screen, colors, color_schema):
        ...
        self.conditions = {
            0 : [Position(0, 0), Position(1, 0), Position(2, 0),  Position(0, 1), Position(1, 1), Position(2, 1), Position(0, 2), Position(1, 2), Position(2, 2)],
            1 : [Position(0, 0), Position(1, 0), Position(2, 0),  Position(0, 1), Position(1, 1), Position(2, 1), Position(0, 2), Position(1, 2), Position(2, 2)],
            2 : [Position(0, 0), Position(1, 0), Position(2, 0),  Position(0, 1), Position(1, 1), Position(2, 1), Position(0, 2), Position(1, 2), Position(2, 2)],
            3 : [Position(0, 0), Position(1, 0), Position(2, 0),  Position(0, 1), Position(1, 1), Position(2, 1), Position(0, 2), Position(1, 2), Position(2, 2)]
        }
        self.condition = 0
