...
# MAIN RHOMBUS OBJECT (BELAH KETUPAT)
class Rhombus:
    def __init__(self, screen, colors, color_schema):
        ...
        self.conditions = {
            0 : [Position(1, 0), Position(2, 0), Position(0, 1),  Position(1, 1), Position(2, 1), Position(3, 1), 
                 Position(0, 2), Position(1, 2), Position(2, 2),  Position(3, 2), Position(1, 3), Position(2, 3)],
            1 : [Position(1, 0), Position(2, 0), Position(0, 1),  Position(1, 1), Position(2, 1), Position(3, 1), 
                 Position(0, 2), Position(1, 2), Position(2, 2),  Position(3, 2), Position(1, 3), Position(2, 3)],
            2 : [Position(1, 0), Position(2, 0), Position(0, 1),  Position(1, 1), Position(2, 1), Position(3, 1), 
                 Position(0, 2), Position(1, 2), Position(2, 2),  Position(3, 2), Position(1, 3), Position(2, 3)],
            3 : [Position(1, 0), Position(2, 0), Position(0, 1),  Position(1, 1), Position(2, 1), Position(3, 1), 
                 Position(0, 2), Position(1, 2), Position(2, 2),  Position(3, 2), Position(1, 3), Position(2, 3)]
        }
        self.condition = 0
